...
public class Groups extends JFrame {
	...
	static int wA2G1; static int wA2G2; static int wA2G3; static int wA2G4; static int dA2G1; static int dA2G2; static int dA2G3; static int dA2G4; static int lA2G1; static int lA2G2; static int lA2G3; static int lA2G4;
	static int gfA2G1; static int gfA2G2; static int gfA2G3; static int gfA2G4; static int gaA2G1; static int gaA2G2; static int gaA2G3; static int gaA2G4;
	
	static int wA3G1; static int wA3G2; static int wA3G3; static int wA3G4; static int dA3G1; static int dA3G2; static int dA3G3; static int dA3G4; static int lA3G1; static int lA3G2; static int lA3G3; static int lA3G4;
	static int gfA3G1; static int gfA3G2; static int gfA3G3; static int gfA3G4; static int gaA3G1; static int gaA3G2; static int gaA3G3; static int gaA3G4;
	        ...
	        contentPane.add(lblTeamA3G1);                 				contentPane.add(lblTeamA3G2);
	          ...
	          btnGrpAG1.addActionListener(new ActionListener() {
	          	public void actionPerformed(ActionEvent e) {
	          		...
	          		if(gfA1G1>gfA2G1) {
	          			wA1G1=1; dA1G1=0; lA1G1=0; uwA1=wA1G1; udA1=dA1G1; ulA1=lA1G1; upA1=uwA1+udA1+ulA1; ptsuA1=3*uwA1+udA1;
	          			wA2G1=0; dA2G1=0; lA2G1=1; uwA2=wA2G1; udA2=dA2G1; ulA2=lA2G1; upA2=wA2G1+dA2G1+lA2G1; ptsuA2=3*wA2G1+dA2G1;
	          			...
	          			wA1G1=0; dA1G1=0; lA1G1=1; uwA1=wA1G1; udA1=dA1G1; ulA1=lA1G1; upA1=wA1G1+dA1G1+lA1G1; ptsuA1=3*wA1G1+dA1G1; 
	          			wA2G1=1; dA2G1=0; lA2G1=0; uwA2=wA2G1; udA2=dA2G1; ulA2=lA2G1; upA2=wA2G1+dA2G1+lA2G1; ptsuA2=3*wA2G1+dA2G1;
	          			...
	          			dA1G1=1; wA1G1=0; lA1G1=0; uwA1=wA1G1; udA1=dA1G1; ulA1=lA1G1; upA1=wA1G1+dA1G1+lA1G1; ptsuA1=3*wA1G1+dA1G1;
	          			dA2G1=1; wA2G1=0; lA2G1=0; uwA2=wA2G1; udA2=dA2G1; ulA2=lA2G1; upA2=wA2G1+dA2G1+lA2G1; ptsuA2=3*wA2G1+dA2G1;
	          		...
	          		TabelaA[] tableA = new TabelaA[3];
					  
					  TabelaA tA1 = new TabelaA(teamA1,upA1,uwA1,udA1,ulA1,ugfA1=Integer.parseInt(gfA1),ugaA1=Integer.parseInt(gfA2),ugdA1=Integer.parseInt(gdA1),ptsuA1);
					  TabelaA tA2 = new TabelaA(teamA2,upA2,uwA2,udA2,ulA2,ugfA2=Integer.parseInt(gfA2),ugaA2=Integer.parseInt(gfA1),ugdA2=Integer.parseInt(gdA2),ptsuA2);
					  TabelaA tA3 = new TabelaA(teamA3,upA3,uwA3=Integer.parseInt(wA3),udA3,ulA3,ugfA3,ugaA3,ugdA3,ptsuA3);
					  ...
					  Arrays.sort(tableA);
					  lblGrpTeamA1.setText(tableA[0].getteamName()); lblPlayedA1.setText(String.valueOf(tableA[0].getPlayed())); lblWinsA1.setText(String.valueOf(tableA[0].getWins())); lblDrawsA1.setText(String.valueOf(tableA[0].getDraws()));   lblLostA1.setText(String.valueOf(tableA[0].getLoses())); lblGFA1.setText(String.valueOf(tableA[0].getGF())); lblGAA1.setText(String.valueOf(tableA[0].getGA())); lblGDA1.setText(String.valueOf(tableA[0].getGD())); lblPtsA1.setText(String.valueOf(tableA[0].getPoints()));
					  lblGrpTeamA2.setText(tableA[1].getteamName()); lblPlayedA2.setText(String.valueOf(tableA[1].getPlayed())); lblWinsA2.setText(String.valueOf(tableA[1].getWins())); lblDrawsA2.setText(String.valueOf(tableA[1].getDraws()));   lblLostA2.setText(String.valueOf(tableA[1].getLoses())); lblGFA2.setText(String.valueOf(tableA[1].getGF())); lblGAA2.setText(String.valueOf(tableA[1].getGA())); lblGDA2.setText(String.valueOf(tableA[1].getGD())); lblPtsA2.setText(String.valueOf(tableA[1].getPoints()));
					  lblGrpTeamA3.setText(tableA[2].getteamName()); lblPlayedA3.setText(String.valueOf(tableA[2].getPlayed())); lblWinsA3.setText(String.valueOf(tableA[2].getWins())); lblDrawsA3.setText(String.valueOf(tableA[2].getDraws()));   lblLostA3.setText(String.valueOf(tableA[2].getLoses())); lblGFA3.setText(String.valueOf(tableA[2].getGF())); lblGAA3.setText(String.valueOf(tableA[2].getGA())); lblGDA3.setText(String.valueOf(tableA[2].getGD())); lblPtsA3.setText(String.valueOf(tableA[2].getPoints()));
	        	  ...
	        	  public void actionPerformed(ActionEvent e) {
	        		    gfA1G2=Integer.parseInt(resultA1G2.getText());
		          		...
		          		if(gfA1G2>gfA3G1) {
		          			...
		          			wA3G1=0; dA3G1=0; lA3G1=1; uwA3=wA3G1; udA3=dA2G1; ulA3=lA3G1; upA3=wA3G1+dA3G1+lA3G1; ptsuA3=3*wA3G1+dA3G1;
		          			...
		          			wA3G1=1; dA3G1=0; lA3G1=0; uwA3=wA3G1; udA3=dA2G1; ulA3=lA3G1; upA3=wA3G1+dA3G1+lA3G1; ptsuA3=3*wA3G1+dA3G1;
		          			...
		          			dA3G1=1; wA3G1=0; lA3G1=0; uwA3=wA3G1; udA3=dA2G1; ulA3=lA3G1; upA3=wA3G1+dA3G1+lA3G1; ptsuA3=3*wA3G1+dA3G1;
		          		...
		          		TabelaA[] tableA = new TabelaA[3];
		          		  ...
		          		  TabelaA tA1 = new TabelaA(teamA1,upA1,uwA1,udA1,ulA1,ugfA1,ugaA1,ugdA1-Integer.parseInt(gfA2),ptsuA1);
						  TabelaA tA2 = new TabelaA(teamA2,upA2,uwA2,udA2,ulA2,ugfA2,ugaA2,ugdA2,ptsuA2);
						  TabelaA tA3 = new TabelaA(teamA3,upA3,uwA3,udA3,ulA3,ugfA3=Integer.parseInt(gfA3),ugaA3=Integer.parseInt(gaA3),ugdA3=Integer.parseInt(gdA3),ptsuA3);
			  ...
			  btnGrpAG3.addActionListener(new ActionListener() {
			  	public void actionPerformed(ActionEvent e) {
					  ...
					  TabelaA tA1 = new TabelaA(teamA1,upA1,uwA1,udA1,ulA1,gfA1G1+gfA1G2,gfA2G1+gfA3G1,(gfA1G1+gfA1G2)-(gfA2G1+gfA3G1),ptsuA1);
					  TabelaA tA2 = new TabelaA(teamA2,upA2,uwA2,udA2,ulA2,ugfA2,ugaA2,ugdA2,ptsuA2);
					  TabelaA tA3 = new TabelaA(teamA3,upA3,uwA3,udA3,ulA3,ugfA3,ugaA3,ugdA3,ptsuA3);
			  ...
			  contentPane.add(lblTeamB3G1);				  					contentPane.add(lblTeamB3G2);
				  ...
				  btnGrpBG2.addActionListener(new ActionListener() {
		        	  public void actionPerformed(ActionEvent e) {
		        		    gfB1G2=Integer.parseInt(resultB1G2.getText());
			          		...
			          		int ugfB1=gfB1G1+gfB1G2;
			          		int ugdB1=ugfB1-gfB3G1;
			          		int ugaB1=gfB2G1+gfB3G1;
			          		int gdB3G1=gfB3G1-gfB1G2;
			          		gfB1=String.valueOf(ugfB1);
			          		gaB1=String.valueOf(ugaB1);
			          		gdB1=String.valueOf(ugdB1);
			          		gfB3=String.valueOf(gfB3G1);
			          		gaB3=String.valueOf(gfB1G2);
			          		gdB3=String.valueOf(gdB3G1);
			          		lblGFB1.setText(gfB1);
			          		lblGAB1.setText(gaB1);
			          		lblGDB1.setText(gdB1);
			          		lblGFB3.setText(gfB3);
			          		lblGAB3.setText(gaB3);
			          		lblGDB3.setText(gdB3);
			          				          			          		
			          		if(gfB1G2>gfB3G1) {
			          			wB1G2=1; dB1G2=0; lB1G2=0; uwB1=wB1G1+wB1G2; udB1=dB1G1+dB1G2; ulB1=lB1G1+lB1G2; upB1=uwB1+udB1+ulB1; ptsuB1=3*uwB1+udB1;
			          			wB3G1=0; dB3G1=0; lB3G1=1; upB3=wB3G1+dB3G1+lB3G1; ptsuB3=3*wB3G1+dB3G1;
			          			
			          			wB1=String.valueOf(uwB1); dB1=String.valueOf(udB1); lB1=String.valueOf(ulB1); pB1=String.valueOf(upB1); ptsB1=String.valueOf(ptsuB1);
			          			lblWinsB1.setText(wB1);   lblDrawsB1.setText(dB1);  lblLostB1.setText(lB1);   lblPlayedB1.setText(pB1); lblPtsB1.setText(ptsB1);
			          			
			          			wB3=String.valueOf(wB3G1); dB3=String.valueOf(dB3G1); lB3=String.valueOf(lB3G1); pB3=String.valueOf(upB3); ptsB3=String.valueOf(ptsuB3);
			          			lblWinsB3.setText(wB3);    lblDrawsB3.setText(dB3);   lblLostB3.setText(lB3);    lblPlayedB3.setText(pB3); lblPtsB3.setText(ptsB3);
			          			
			          		}
			          		else if(gfB1G2<gfB3G1) {
			          			wB3G1=1; dB3G1=0; lB3G1=0; upB3=wB3G1+dB3G1+lB3G1; ptsuB3=3*wB3G1+dB3G1;
			          			wB1G2=0; dB1G2=0; lB1G2=1; uwB1=wB1G1+wB1G2; udB1=dB1G1+dB1G2; ulB1=lB1G1+lB1G2; upB1=uwB1+udB1+ulB1; ptsuB1=3*uwB1+udB1; 
			          			...
			          			dB1G2=1; wB1G2=0; lB1G2=0; uwB1=wB1G1+wB1G2; udB1=dB1G1+dB1G2; ulB1=lB1G1+lB1G2; upB1=uwB1+udB1+ulB1; ptsuB1=3*uwB1+udB1;
			          			dB3G1=1; wB3G1=0; lB3G1=0; upB3=wB3G1+dB3G1+lB3G1; ptsuB3=3*wB3G1+dB3G1;
				  ...
				  btnGrpBG3.addActionListener(new ActionListener() {
					  	public void actionPerformed(ActionEvent e) {
			          		...
			          		int ugfB2=gfB2G1+gfB2G2;
			          		int ugaB2=gfB1G1+gfB3G2;
			          		int ugdB2=ugfB2-ugaB2;
			          		int ugfB3=gfB3G1+gfB3G2;
			          		int ugaB3=gfB2G2+gfB1G2;
			          		int ugdB3=ugfB3-ugaB3;
			          		gfB2=String.valueOf(ugfB2);
			          		gaB2=String.valueOf(ugaB2);
			          		gdB2=String.valueOf(ugdB2);
			          		gfB3=String.valueOf(ugfB3);
			          		gaB3=String.valueOf(ugaB3);
			          		gdB3=String.valueOf(ugdB3);
			          		lblGFB2.setText(gfB2);
			          		lblGAB2.setText(gaB2);
			          		lblGDB2.setText(gdB2);
			          		lblGFB3.setText(gfB3);
			          		lblGAB3.setText(gaB3);
			          		lblGDB3.setText(gdB3);
			          		...
			          		if(gfB2G2>gfB3G2) {
			          			wB2G2=1; dB2G2=0; lB2G2=0; uwB2=wB2G1+wB2G2; udB2=dB2G1+dB2G2; ulB2=lB2G1+lB2G2; upB2=uwB2+udB2+ulB2; ptsuB2=3*uwB2+udB2;
			          			wB3G2=0; dB3G2=0; lB3G2=1; uwB3=wB3G1+wB3G2; udB3=dB3G1+dB3G2; ulB3=lB3G1+lB3G2; upB3=uwB3+udB3+ulB3; ptsuB3=3*uwB3+udB3;
			          			
			          			wB2=String.valueOf(uwB2); dB2=String.valueOf(udB2); lB2=String.valueOf(ulB2); pB2=String.valueOf(upB2); ptsB2=String.valueOf(ptsuB2);
			          			lblWinsB2.setText(wB2);   lblDrawsB2.setText(dB2);  lblLostB2.setText(lB2);   lblPlayedB2.setText(pB2); lblPtsB2.setText(ptsB2);
			          			
			          			wB3=String.valueOf(uwB3); dB3=String.valueOf(udB3); lB3=String.valueOf(ulB3); pB3=String.valueOf(upB3); ptsB3=String.valueOf(ptsuB3);
			          			lblWinsB3.setText(wB3);    lblDrawsB3.setText(dB3);   lblLostA3.setText(lB3);    lblPlayedB3.setText(pB3); lblPtsB3.setText(ptsB3);
			          			
			          		}
			          		else if(gfB2G2<gfB3G2) {
			          			wB2G2=0; dB2G2=0; lB2G2=1; uwB2=wB2G1+wB2G2; udB2=dB2G1+dB2G2; ulB2=lB2G1+lB2G2; upB2=uwB2+udB2+ulB2; ptsuB2=3*uwB2+udB2;
			          			wB3G2=1; dB3G2=0; lB3G2=0; uwB3=wB3G1+wB3G2; udB3=dB3G1+dB3G2; ulB3=lB3G1+lB3G2; upB3=uwB3+udB3+ulB3; ptsuB3=3*uwB3+udB3;
			          			...
			          			dB2G2=1; wB2G2=0; lB2G2=0; uwB2=wB2G1+wB2G2; udB2=dB2G1+dB2G2; ulB2=lB2G1+lB2G2; upB2=uwB2+udB2+ulB2; ptsuB2=3*uwB2+udB2;
			          			dB3G2=1; wB3G2=0; lB3G2=0; uwB3=wB3G1+wB3G2; udB3=dB3G1+dB3G2; ulB3=lB3G1+lB3G2; upB3=uwB3+udB3+ulB3; ptsuB3=3*uwB3+udB3;
				  ...
				  btnGrpBG4.addActionListener(new ActionListener() {
			          	public void actionPerformed(ActionEvent e) {
			          		...
			          		int ugfB1=gfB1G1+gfB1G2+gfB1G3;
			          		int ugaB1=gfB2G1+gfB3G1+gfB2G3;
			          		int ugdB1=ugfB1-ugaB1;
			          		int ugfB2=gfB2G1+gfB2G2+gfB2G3;
			          		int ugaB2=gfB1G1+gfB3G2+gfB1G3;
			          		int ugdB2=ugfB2-ugaB2;
			          		gfB1=String.valueOf(ugfB1);
			          		gfB2=String.valueOf(ugfB2);
			          		gaB1=String.valueOf(ugaB1);
			          		...
			          		if(gfB1G3>gfB2G3) {
			          			wB1G3=1; dB1G3=0; lB1G3=0; uwB1=wB1G1+wB1G2+wB1G3; udB1=dB1G1+dB1G2+dB1G3; ulB1=lB1G1+lB1G2+lB1G3; upB1=uwB1+udB1+ulB1; ptsuB1=3*uwB1+udB1;
			          			wB2G3=0; dB2G3=0; lB2G3=1; uwB2=wB2G1+wB2G2+wB2G3; udB2=dB2G1+dB2G2+dB2G3; ulB2=lB2G1+lB2G2+lB2G3; upB2=uwB2+udB2+ulB2; ptsuB2=3*uwB2+udB2;
			          			...
			          			wB2G3=1; dB2G3=0; lB2G3=0; uwB1=wB1G1+wB1G2+wB1G3; udB1=dB1G1+dB1G2+dB1G3; ulB1=lB1G1+lB1G2+lB1G3; upB1=uwB1+udB1+ulB1; ptsuB1=3*uwB1+udB1; 
			          			wB1G3=0; dB1G3=0; lB1G3=1; uwB2=wB2G1+wB2G2+wB2G3; udB2=dB2G1+dB2G2+dB2G3; ulB2=lB2G1+lB2G2+lB2G3; upB2=uwB2+udB2+ulB2; ptsuB2=3*uwB2+udB2;
			          			...
			          			dB1G3=1; wB1G3=0; lB1G3=0; uwB1=wB1G1+wB1G2+wB1G3; udB1=dB1G1+dB1G2+dB1G3; ulB1=lB1G1+lB1G2+lB1G3; upB1=uwB1+udB1+ulB1; ptsuB1=3*uwB1+udB1;
			          			dB2G3=1; wB2G3=0; lB2G3=0; uwB2=wB2G1+wB2G2+wB2G3; udB2=dB2G1+dB2G2+dB2G3; ulB2=lB2G1+lB2G2+lB2G3; upB2=uwB2+udB2+ulB2; ptsuB2=3*uwB2+udB2;
				  ...
				  btnGrpBG5.addActionListener(new ActionListener() {
			          	public void actionPerformed(ActionEvent e) {
			          		...
			          		int ugfB1=gfB1G1+gfB1G2+gfB1G3+gfB1G4;
			          		int ugaB1=gfB2G1+gfB3G1+gfB2G3+gfB3G3;
			          		int ugdB1=ugfB1-ugaB1;
			          		int ugfB3=gfB3G1+gfB3G2+gfB3G3;
			          		int ugaB3=gfB1G2+gfB2G2+gfB1G4;
			          		int ugdB3=ugfB3-ugaB3;
			          		gfB1=String.valueOf(ugfB1);
			          		gfB3=String.valueOf(ugfB3);
			          		gaB1=String.valueOf(ugaB1);
			          		...
			          		if(gfB1G4>gfB3G3) {
			          			...
			          			wB3G3=0; dB3G3=0; lB3G3=1; uwB3=wB3G1+wB3G2+wB3G3; udB3=dB3G1+dB3G2+dB3G3; ulB3=lB3G1+lB3G2+lB3G3; upB3=uwB3+udB3+ulB3; ptsuB3=3*uwB3+udB3;
			          			...
			          			wB3G3=1; dB3G3=0; lB3G3=0; uwB3=wB3G1+wB3G2+wB3G3; udB3=dB3G1+dB3G2+dB3G3; ulB3=lB3G1+lB3G2+lB3G3; upB3=uwB3+udB3+ulB3; ptsuB3=3*uwB3+udB3; 
			          			...
			          			dB3G3=1; wB3G3=0; lB3G3=0; uwB3=wB3G1+wB3G2+wB3G3; udB3=dB3G1+dB3G2+dB3G3; ulB3=lB3G1+lB3G2+lB3G3; upB3=uwB3+udB3+ulB3; ptsuB3=3*uwB3+udB3;
				  ...
				  btnGrpBG6.addActionListener(new ActionListener() {
			          	public void actionPerformed(ActionEvent e) {
			          		...
			          		int ugfB2=gfB2G1+gfB2G2+gfB2G3+gfB2G4;
			          		int ugaB2=gfB1G1+gfB3G2+gfB1G3+gfB3G4;
			          		int ugdB2=ugfB2-ugaB2;
			          		int ugfB3=gfB3G1+gfB3G2+gfB3G3+gfB3G4;
			          		int ugaB3=gfB1G2+gfB2G2+gfB1G4+gfB2G4;
			          		int ugdB3=ugfB3-ugaB3;
			          		gfB2=String.valueOf(ugfB2);
			          		gfB3=String.valueOf(ugfB3);
			          		gaB2=String.valueOf(ugaB2);
